...
-- MMLU-Pro
SELECT m.id, b.id, 72.6, 72.6, '2024',
       'https://openai.com/index/hello-gpt-4o/', 'medium', '2024-05-13'::TIMESTAMPTZ
FROM b, models m WHERE b.name = 'MMLU-Pro' AND m.slug = 'openai/gpt-4o'
UNION ALL
-- GPQA Diamond
SELECT m.id, b.id, 53.6, 53.6, '2024',
       'https://openai.com/index/hello-gpt-4o/', 'medium', '2024-05-13'::TIMESTAMPTZ
FROM b, models m WHERE b.name = 'GPQA Diamond' AND m.slug = 'openai/gpt-4o'
UNION ALL
-- IFEval
SELECT m.id, b.id, 84.9, 84.9, '2024',
       'https://openai.com/index/hello-gpt-4o/', 'medium', '2024-05-13'::TIMESTAMPTZ
FROM b, models m WHERE b.name = 'IFEval' AND m.slug = 'openai/gpt-4o'
UNION ALL
-- MATH-500
SELECT m.id, b.id, 76.6, 76.6, '2024',
       'https://openai.com/index/hello-gpt-4o/', 'medium', '2024-05-13'::TIMESTAMPTZ
FROM b, models m WHERE b.name = 'MATH-500' AND m.slug = 'openai/gpt-4o'
UNION ALL
-- Chatbot Arena
SELECT m.id, b.id, 1285, 85.0, '2024',
       'https://lmarena.ai/?leaderboard', 'high', '2024-12-01'::TIMESTAMPTZ
...
-- ============================================================
-- MMLU-Pro
SELECT m.id, b.id, 63.2, 63.2, '2024',
       'https://openai.com/index/gpt-4o-mini-advancing-cost-efficient-intelligence/', 'medium', '2024-07-18'::TIMESTAMPTZ
FROM b, models m WHERE b.name = 'MMLU-Pro' AND m.slug = 'openai/gpt-4o-mini'
UNION ALL
-- MATH-500
SELECT m.id, b.id, 70.2, 70.2, '2024',
       'https://openai.com/index/gpt-4o-mini-advancing-cost-efficient-intelligence/', 'medium', '2024-07-18'::TIMESTAMPTZ
FROM b, models m WHERE b.name = 'MATH-500' AND m.slug = 'openai/gpt-4o-mini'
UNION ALL
-- IFEval
SELECT m.id, b.id, 80.0, 80.0, '2024',
       'https://openai.com/index/gpt-4o-mini-advancing-cost-efficient-intelligence/', 'medium', '2024-07-18'::TIMESTAMPTZ
FROM b, models m WHERE b.name = 'IFEval' AND m.slug = 'openai/gpt-4o-mini'
UNION ALL
-- Chatbot Arena
SELECT m.id, b.id, 1216, 78.0, '2024',
       'https://lmarena.ai/?leaderboard', 'high', '2024-12-01'::TIMESTAMPTZ
...
-- ============================================================
-- MMLU-Pro
SELECT m.id, b.id, 64.1, 64.1, '2024',
       'https://arxiv.org/abs/2406.01574', 'high', '2024-06-01'::TIMESTAMPTZ
FROM b, models m WHERE b.name = 'MMLU-Pro' AND m.slug = 'openai/gpt-4-turbo'
UNION ALL
-- GPQA Diamond
SELECT m.id, b.id, 49.3, 49.3, '2024',
       'https://arxiv.org/abs/2311.12022', 'high', '2024-06-01'::TIMESTAMPTZ
FROM b, models m WHERE b.name = 'GPQA Diamond' AND m.slug = 'openai/gpt-4-turbo'
UNION ALL
-- Chatbot Arena
SELECT m.id, b.id, 1260, 83.0, '2024',
       'https://lmarena.ai/?leaderboard', 'high', '2024-12-01'::TIMESTAMPTZ
...
-- ============================================================
-- MMLU-Pro
SELECT m.id, b.id, 52.9, 52.9, '2024',
       'https://arxiv.org/abs/2406.01574', 'high', '2024-06-01'::TIMESTAMPTZ
FROM b, models m WHERE b.name = 'MMLU-Pro' AND m.slug = 'anthropic/claude-3-haiku'
UNION ALL
-- IFEval
SELECT m.id, b.id, 75.4, 75.4, '2024',
       'https://www.anthropic.com/news/claude-3-family', 'medium', '2024-03-04'::TIMESTAMPTZ
FROM b, models m WHERE b.name = 'IFEval' AND m.slug = 'anthropic/claude-3-haiku'
UNION ALL
-- Chatbot Arena
SELECT m.id, b.id, 1178, 73.0, '2024',
       'https://lmarena.ai/?leaderboard', 'high', '2024-12-01'::TIMESTAMPTZ
...
-- ============================================================
-- MMLU-Pro
SELECT m.id, b.id, 69.0, 69.0, '2024',
       'https://arxiv.org/abs/2406.01574', 'high', '2024-06-01'::TIMESTAMPTZ
FROM b, models m WHERE b.name = 'MMLU-Pro' AND m.slug = 'google/gemini-1-5-pro'
UNION ALL
-- MATH-500
SELECT m.id, b.id, 67.7, 67.7, '2024',
       'https://storage.googleapis.com/deepmind-media/gemini/gemini_v1_5_report.pdf', 'medium', '2024-05-01'::TIMESTAMPTZ
FROM b, models m WHERE b.name = 'MATH-500' AND m.slug = 'google/gemini-1-5-pro'
UNION ALL
-- Video-MME
SELECT m.id, b.id, 81.3, 81.3, '2024',
       'https://storage.googleapis.com/deepmind-media/gemini/gemini_v1_5_report.pdf', 'medium', '2024-05-01'::TIMESTAMPTZ
FROM b, models m WHERE b.name = 'Video-MME' AND m.slug = 'google/gemini-1-5-pro'
UNION ALL
-- Chatbot Arena
SELECT m.id, b.id, 1264, 83.5, '2024',
       'https://lmarena.ai/?leaderboard', 'high', '2024-12-01'::TIMESTAMPTZ
