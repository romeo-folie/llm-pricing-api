...
- [ ] `POST /auth/signup/request-link` returns **503** with RFC 7807 body: `{"type":"https://llmrates.live/problems/service-unavailable","title":"Service Unavailable","status":503,"detail":"signup is currently disabled","instance":"/auth/signup/request-link"}`
